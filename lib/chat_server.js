...
/*
    define the chat server function listen. This function is invoked in server.js.
...
exports.listen = function(server) {
    ...
    io.sockets.on('connection', function(socket){ //Define how each user connection will be handled
        ...
        console.log("currentRoom" + currentRoom.toString());
        console.log("nickNames" + nickNames.toString());
        console.log("namesUsed" + namesUsed.toString());
    });
